...
while True :
    ...
    while True :
        while title_screen == 1 : # Title Screen
            ...
            print("===========================================")
            title_options = input("Type an option here : ")

            if title_options == "s" or title_options == "+" :
                title_screen = 0
                break
            elif title_options == "a" or title_options == "*" :
                print("\nAbout")
                print("===========================================")
                print("")
            ...
            elif title_options == "x" or title_options == "-" :
                exit_key = 1
                break
            else :
        ...
        while True :
            ...
            print("")
            print("(  ,  ) - Random ( Under Construction )")
            print("(s , +) - Start")
            print("(x , -) - Back to title screen")
            print("===========================================")
            options = input("Type an option here : ")
            ...
            if options == "1" :
                ...
                while True :  # Range number input
                    ran_num1 = input("\nInsert number from : ")
                    ran_num2 = input("Insert number to   : ")
    ...
    for i in range(int(noround)) :
        ...
        # Status bar
        print(f"\n{round(real_accu,2)}%  {correct} | {wrong}  {combo}x  Score : {score}")
        ...
        if cor_count == 1 :
            if real_accu != 100.00 :
                real_accu = real_accu + ((100 - real_accu) * (25 / 100))
        ...
        if wrong_count == 1 :
            if real_accu == 100.00 :
                real_accu = real_accu - (real_accu * (2.5 / 100))
            else :
                real_accu = real_accu - ((100 - real_accu) * (25 / 100))
            combo = 0
