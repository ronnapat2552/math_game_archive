            ...
            if title_options == "s" or title_options == "+" : # Start
                ...
                while True :
                    ...
                    if setting_options == "x"or setting_options == "/"  : # Exit
                        ...
                        print(f"({setting_options}) {list(value)[int(setting_options) - 1]} [ {setting.get(list(value)[int(setting_options) - 1])}{setting_unit[int(setting_options) - 1]} ]")
                ...
                print("\nLink to Project")
                print("sites.google.com/view/tete-page/project/math-game")
                print("===========================================")
    ...
    while True:
        ...
        if end_options == "i" or end_options == "/" : # Session info
            ...
            while True :
                print("\nSave Game")
                print("===========================================")
                print(f"(1) - Save as       : {file_save_name}.txt")
